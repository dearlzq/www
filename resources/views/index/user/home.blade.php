...
<div class="pages section">
    <div class="container">
        ...
        <div class="contact-us">
            <div class="row">
                <div class="col s12">
                    <form action="{{url('add_do')}}" class="contact-form" id="contact-form" method="post">
                       ...
                       <div class="new-photo">
                        ...
                        <div class="form-group" id="name-field">
                            <input type="text" class="validate"  name="y_name" id="form-name" name="form-name" placeholder="昵称" required>
                        </div>

                        <div class="form-group">
                            <button class="btn button-default" type="submit" id="submit" name="submit">提交</button>
                        </div>
                    </form>
                </div>
            </div>
